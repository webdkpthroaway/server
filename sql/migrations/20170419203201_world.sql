...
UPDATE `quest_template` SET `RequiredMinRep` = 0 WHERE `entry` = 8743;

-- Make "Treasure of the Timeless One" obtainable at neutral rep
UPDATE `quest_template` SET `RequiredMinRep` = 0 WHERE `entry` = 8745;

INSERT INTO `script_texts` (`entry`, `content_default`, `content_loc1`, `content_loc2`, `content_loc3`, `content_loc4`, `content_loc5`, `content_loc6`, `content_loc7`, `content_loc8`, `sound`, `type`, `language`, `emote`, `comment`) VALUES
(-1000007,  '%N, Champion of the Bronze Dragonflight, has rung the Scarab Gong. The ancient gates of Ahn\'Qiraj open, revealing the horrors of a forgotten war...', NULL,   NULL,   NULL,   NULL,   NULL,   NULL,   NULL,   NULL,   0,  2,  0,  0,  NULL),
